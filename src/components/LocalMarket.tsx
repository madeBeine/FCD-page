...
export const LocalMarket = () => {
  ...
  const content = config.content[config.language].localMarket;
  const isRtl = config.language === 'ar';

  return (
    <section id="localMarket" className="py-24 relative bg-brand-bg dark:bg-slate-900 overflow-hidden transition-colors duration-300">
      <AdminToolbar sectionId="localMarket" />
      
      <div className="container mx-auto px-4 md:px-6">
        <div className="bg-white dark:bg-slate-800 rounded-[2.5rem] p-8 md:p-12 lg:p-16 shadow-xl border border-slate-100 dark:border-slate-700 relative overflow-hidden transition-colors duration-300">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 relative z-10">
            ...
            <div className="flex-1 text-center lg:text-start">
              ...
              <button className="bg-brand-orange hover:bg-brand-orange/90 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all hover:shadow-lg hover:shadow-brand-orange/30 flex items-center justify-center gap-2 group mx-auto lg:mx-0">
