        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="space-y-4">
              <a href={config.content[config.language].appLinks.ios} target="_blank" rel="noopener noreferrer" className="w-full bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 rounded-xl p-3 flex items-center gap-4 transition-colors shadow-sm">
              ...
              <a href={config.content[config.language].appLinks.android} target="_blank" rel="noopener noreferrer" className="w-full bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 rounded-xl p-3 flex items-center gap-4 transition-colors shadow-sm">
