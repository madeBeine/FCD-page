...
export const Services = () => {
  ...
  return (
    <section id="services" className="py-24 relative bg-transparent transition-colors duration-300 overflow-hidden">
          ...
          {content.items.map((service: any, index: number) => {
            ...
            return (
              <motion.div 
                ...
                className={`group relative p-8 rounded-3xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 hover:bg-white dark:hover:bg-slate-800 hover:shadow-2xl hover:-translate-y-1 hover:shadow-brand-blue/5 dark:hover:shadow-brand-blue/10 transition-all duration-300 overflow-hidden ${service.isVisible === false ? 'opacity-50 grayscale' : ''}`}
              >
