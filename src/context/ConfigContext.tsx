...
export const ConfigProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
        ...
        if (data) {
          setConfig(prev => {
            ...
            return {
              ...
              adminCode: data.admin_code || prev.adminCode,
            };
          });
  ...
  return (
    <ConfigContext.Provider value={{
      ...
      saveConfig,
      updateMapCities,
      hasUnsavedChanges: false, // Stub for now
      discardChanges: () => {}, // Stub for now
      showNotification: () => {}, // Stub for now
      isDownloadModalOpen,
      openDownloadModal,
      closeDownloadModal
    }}>
