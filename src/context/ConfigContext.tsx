...
const initialContent = {
  ar: {
    ...
    howItWorks: {
      ...
      steps: [
        { title: 'انسخ الرابط', description: 'ابحث عن منتجك المفضل في أي متجر عالمي وانسخ رابطه.', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-woman-shopping-online-on-a-tablet-39766-large.mp4' },
        { title: 'الصق في التطبيق', description: 'افتح تطبيق فاست كوماند والصق الرابط لطلب المنتج.', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-hands-holding-a-smartphone-with-a-green-screen-43004-large.mp4' },
        { title: 'استلم طلبك', description: 'سنتكفل بالشراء والشحن حتى يصل إلى باب منزلك.', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-delivery-man-delivering-a-package-40035-large.mp4' },
      ],
    },
    services: {
  ...
  en: {
    ...
    howItWorks: {
      ...
      steps: [
        { title: 'Copy Link', description: 'Find your desired product on any global store and copy its link.', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-woman-shopping-online-on-a-tablet-39766-large.mp4' },
        { title: 'Paste in App', description: 'Open the Fast Comand app and paste the link to order.', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-hands-holding-a-smartphone-with-a-green-screen-43004-large.mp4' },
        { title: 'Receive Order', description: 'We handle the purchase and shipping right to your door.', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-delivery-man-delivering-a-package-40035-large.mp4' },
      ],
    },
    services: {
  ...
  fr: {
    ...
    howItWorks: {
      ...
      steps: [
        { title: 'Copiez le lien', description: 'Trouvez votre produit souhaité sur n\'importe quel magasin mondial et copiez son lien.', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-woman-shopping-online-on-a-tablet-39766-large.mp4' },
        { title: 'Collez dans l\'application', description: 'Ouvrez l\'application Fast Comand et collez le lien pour commander.', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-hands-holding-a-smartphone-with-a-green-screen-43004-large.mp4' },
        { title: 'Recevez votre commande', description: 'Nous nous occupons de l\'achat et de l\'expédition jusqu\'à votre porte.', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-delivery-man-delivering-a-package-40035-large.mp4' },
      ],
    },
    services: {
